const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes, RapidAgent supports about 90 languages. You can have your sources in any language and ask it questions in any language.',
  },
  {
    id: 5,
    ...
    <div className="bg-black">
      <div className="px-6 py-16 mx-auto max-w-7xl sm:py-24 lg:px-8">
        ...
        <p className="max-w-2xl mt-6 text-base leading-7 text-gray-300">
          ...
          <a
            href="mailto:support@rapidagent.ai"
